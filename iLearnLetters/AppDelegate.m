...
{
    [Parse setApplicationId:@"Kl9b39zjb9GbgrucRyjm3J7HkUDbFJcp2kP3bpFq"
                  clientKey:@"f5fxEhpMn546GBq5XyiOSAnrASFK6FNvcCVciGud"];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"iLearnLetters" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"iLearnLetters.sqlite"];
